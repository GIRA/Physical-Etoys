...
#define MASK_CALL_PROLOGUES (1 << 0)
#define MASK_ALL_DEBUG (1 << 1)
#define MASK_INT8 (1 << 2)
#define MASK_NO_INTERRUPTS (1 << 3)
#define MASK_ORDER_1 (1 << 4)
#define MASK_ORDER_2 (1 << 5)
#define MASK_SHORT_CALLS (1 << 6)
#define MASK_TINY_STACK (1 << 7)
...
enum opt_code
{
  ...
  OPT_mcall_prologues,                       /* -mcall-prologues */
  OPT_mdeb,                                  /* -mdeb */
  OPT_mint8,                                 /* -mint8 */
  OPT_mmcu_,                                 /* -mmcu= */
  OPT_mno_interrupts,                        /* -mno-interrupts */
  OPT_morder1,                               /* -morder1 */
  OPT_morder2,                               /* -morder2 */
  OPT_mpmem_wrap_around,                     /* -mpmem-wrap-around */
  OPT_mrelax,                                /* -mrelax */
  OPT_mshort_calls,                          /* -mshort-calls */
  OPT_mtiny_stack,                           /* -mtiny-stack */
