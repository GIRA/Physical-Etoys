...
public:
  IRrecv() {}  //##Minibloq ##2013.01.23: (Richo) This was commented, I uncommented it.
  IRrecv(int recvpin);
  void setPin(int recvpin);  //##Minibloq ##2013.01.23: (Richo) This was commented, I uncommented it and added void return type.
