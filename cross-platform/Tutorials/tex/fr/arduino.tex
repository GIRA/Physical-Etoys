...
Avant de pouvoir manipuler dans \appName, il est nécessaire de connecter
physiquement la LED sur la carte.  Dans cet exemple, la cathode doit être
...
autres composants électroniques que fournit \appName très nombreuses : nous
